...
import { GetUsersArgs } from './dto/args/get-users.arg';
...
export class UsersService {
  ...
  public getUser(getUsersArgs: GetUserArgs): User {
    return this.users.find((user) => user.userId === getUsersArgs.userId);
  }
